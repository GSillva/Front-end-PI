$( document ).ready(function() {
  ...
  function shinobu(){
    ...
    const div = document.getElementById('hashira');

    div.innerHTML += `<div>
    <img src="${picture}"  alt="...">
    <div >
      <h5 > Cachorrinhos precisando receber doações: ${inst}.</h5>
      <p >  ${desc} </p>
      <a href="https://www.instagram.com/cantinhoamigobicho/?hl=pt-br" >Contato!</a>
    </div>
  </div>`;
